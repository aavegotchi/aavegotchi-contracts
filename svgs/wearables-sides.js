...
const wearablesRightSvgs = [
  ...
  bodyWearableRight('227_MJJersey'),
  wearable('228_10GallonHatRight'),
  wearable('229_LassoRight'),
  bodyWearableRight('230_WraanglerJeans'),
  bodyWearableRight('231_ComfyPoncho'),
  bodyWearableRight('232_PonchoHoodie'),
  wearable('233_UncommonCactiRight'),
  bodyWearableRight('234_ShaamanPoncho'),
  bodyWearableRight('235_ShaamanHoodie'),
  wearable('236_BlueCactiRight'),
  wearable('237_MythicalCactiRight'),
...
const wearablesBackSvgs = [
  ...
  wearable('214_MatrixEyesBack'),
  wearable('215	CyborgEyeBack'),
  wearable('216_RainbowVomitBack'),
  wearable('217_CyborgGunBack'),
  wearable('218_MohawkBack'),
  wearable('219_MuttonChopsBack'),
...
const wearablesLeftSleeveSvgs = [
  ...
  sleeveWearableLeft('235_ShaamanHoodie'),
...
const wearablesRightSleeveSvgs = [
  ...
  sleeveWearableRight('235_ShaamanHoodie'),
