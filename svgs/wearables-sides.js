...
const wearablesRightSvgs = [
  ...
  bodyWearableRight('8_MarineJacketRight'), // bodyWearableRight("8_MarineJacket"),
  wearable('9_WalkieTalkieRight'),
  wearable('10_LinkWhiteHatRight'),
  bodyWearableRight('11_MessDressRight'), // bodyWearableRight("11_MessDress"),
  wearable('12_LinkBubblyRight'),
  wearable('13_SergeyBeardRight'),
  wearable('14_SergeyEyesRight'),
  bodyWearableRight('15_RedPlaidRight'), // bodyWearableRight("15_RedPlaid"),
  bodyWearableRight('16_BluePlaidRight'), //  bodyWearableRight("16_BluePlaid"),
...
const wearablesLeftSvgs = [
  ...
  bodyWearableLeft('8_MarineJacketLeft'), // bodyWearableLeft("8_MarineJacket"),
  wearable('9_WalkieTalkieLeft'),
  wearable('10_LinkWhiteHatLeft'),
  bodyWearableLeft('11_MessDressLeft'), // bodyWearableLeft("11_MessDress"),
...
//   let svg = readSvg(name)
//   const leftSleevesUp = '<g class="gotchi-sleeves gotchi-sleeves-left gotchi-sleeves-up">' + readSvg(`${name}Up`) + '</g>'
//   const leftSleeves = '<g class="gotchi-sleeves gotchi-sleeves-left gotchi-sleeves-down">' + readSvg(`${name}`) + '</g>'
//   svg = '<g>' + svg + leftSleevesUp + leftSleeves + '</g>'
//   return svg
// }
//
// function bodyWearableRight (name) {
//   const rightSleevesUp = '<g class="gotchi-sleeves gotchi-sleeves-right gotchi-sleeves-up">' + readSvg(`${name}Up`) + '</g>'
//   const rightSleeves = '<g class="gotchi-sleeves gotchi-sleeves-right gotchi-sleeves-down">' + readSvg(`${name}`) + '</g>'
//   svg = '<g>' + svg + rightSleevesUp + rightSleeves + '</g>'
//   return svg
// }
