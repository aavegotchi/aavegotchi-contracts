const fs = require('fs')
const sealedClosedPortal = fs.readFileSync('./svgs/h1-closed.svg', 'utf8')
...
const shadow = '<g class="gotchi-shadow"><path opacity=".25" d="M25 58H19v1h1v1h24V59h1V58h-1z" fill="#000"/></g>'
