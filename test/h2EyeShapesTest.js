...
const { upgradeH2EyeShapes } = require("../scripts/upgrades/upgrade-h2EyeShapes.js");
...
describe("Upgrade H2 eye shapes", async function() {
  ...
  before(async function() {
    ...
    ghstTokenContract = await (await ethers.getContractAt("GHSTFacet", ghstAddress)).connect(signer);
