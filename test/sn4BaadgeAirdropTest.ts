...
import { main } from "../scripts/airdrops/rfSzn4BdgsAirdrop";
...
describe("Airdrop SZN4 Baadges", async function () {
  this.timeout(200000000);

  let aavegotchiFacet: AavegotchiFacet,
    signer: Signer,
    rarityRFSzn4: number[],
    kinshipRFSzn4: number[],
    xpRFSzn4: number[];
  ...
  it.only("Should airdrop szn4 champion baadges", async function () {
    //rarity champ
    let rarityChamp = await aavegotchiFacet.getAavegotchi(rarityRFSzn4[0]);
    ...
    //kinship champ
    let kinshipChamp = await aavegotchiFacet.getAavegotchi(kinshipRFSzn4[0]);
    ...
    //xp champ (tiebreaker)
    let xpChamp = await aavegotchiFacet.getAavegotchi(xpRFSzn4[0]);
  ...
  it.only("Should airdrop szn4 2nd and 3rd place baadges", async function () {
    //rarity 2nd
    let rarity2nd = await aavegotchiFacet.getAavegotchi(rarityRFSzn4[1]);
    ...
    //kinship 2nd
    let kinship2nd = await aavegotchiFacet.getAavegotchi(kinshipRFSzn4[1]);
    ...
    //xp 2nd (tiebreaker)
    let xp2nd = await aavegotchiFacet.getAavegotchi(xpRFSzn4[1]);
    ...
    //rarity 3rd
    let rarity3rd = await aavegotchiFacet.getAavegotchi(rarityRFSzn4[2]);
    ...
    //kinship 3rd
    let kinship3rd = await aavegotchiFacet.getAavegotchi(kinshipRFSzn4[2]);
    ...
    //xp 3rd
    let xp3rd = await aavegotchiFacet.getAavegotchi(xpRFSzn4[2]);
  ...
  it.only("Should airdrop szn4 top10 baadges", async function () {
    //rarity top 10
    let rarityTop10 = await aavegotchiFacet.getAavegotchi(rarityRFSzn4[3]);
    ...
    rarityTop10 = await aavegotchiFacet.getAavegotchi(rarityRFSzn4[9]);
    ...
    //kinship top 10
    let kinshipTop10 = await aavegotchiFacet.getAavegotchi(kinshipRFSzn4[3]);
    item = kinshipTop10.items[kinshipTop10.items.length - 2];
    baadge = item[item.length - 1].toString();
    ...
    kinshipTop10 = await aavegotchiFacet.getAavegotchi(kinshipRFSzn4[9]);
    ...
    //XP top 10
    let xpTop10 = await aavegotchiFacet.getAavegotchi(xpRFSzn4[3]);
    ...
    xpTop10 = await aavegotchiFacet.getAavegotchi(xpRFSzn4[9]);
  ...
  it.only("Should airdrop szn4 top100 baadges", async function () {
    //rarity top 100
    let rarityTop100 = await aavegotchiFacet.getAavegotchi(rarityRFSzn4[10]);
    ...
    rarityTop100 = await aavegotchiFacet.getAavegotchi(rarityRFSzn4[99]);
    ...
    //kinship top 100
    let kinshipTop100 = await aavegotchiFacet.getAavegotchi(kinshipRFSzn4[10]);
    ...
    kinshipTop100 = await aavegotchiFacet.getAavegotchi(kinshipRFSzn4[99]);
    item = kinshipTop100.items[kinshipTop100.items.length - 1];
    baadge = item[item.length - 1].toString();
    ...
    //XP top 100
    let xpTop100 = await aavegotchiFacet.getAavegotchi(xpRFSzn4[10]);
    ...
    xpTop100 = await aavegotchiFacet.getAavegotchi(xpRFSzn4[99]);
    item = xpTop100.items[xpTop100.items.length - 1];
    baadge = item[item.length - 1].toString();
