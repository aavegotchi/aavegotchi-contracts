...
describe('Re-deploying Contracts, replacing facet selectors, and uploading H1 collateral types', async function () {
  ...
  //     await daoFacet.mintItems(account, [testWearableId], ['10'])
  //     balance = await itemsFacet.balanceOf(account, testWearableId)
  //     expect(balance).to.equal(10)
  //
  //     // await daoFacet.mintItems(account, [62], ['10'])
  //
  //     // const result = await itemsFacet.itemBalancesWithSlots(account)
  //     // console.log(result)
  //   })
  //
  ...
  //       '10' // uint256 _value
  //     )
  //     const balance = await itemsFacet.balanceOfToken(aavegotchiFacet.address, testAavegotchiId, testWearableId)
  //     expect(balance).to.equal(10)
  //   })
  //
  ...
  //       '10' // uint256 _value
  //     )
  //     const balance = await itemsFacet.balanceOf(account, testWearableId)
  //     expect(balance).to.equal(10)
  //   })
  //
  ...
  //     expect(await itemsFacet.balanceOfToken(aavegotchiFacet.address, testAavegotchiId, testWearableId)).to.equal(10)
  //
  ...
  //     //   allowedCollaterals: []
  //     // },
  //     await daoFacet.mintItems(account, [97, 98, 99, 100], [5, 5, 5, 5])
  ...
  //     await itemsFacet.equipWearables(testAavegotchiId, wearableIds)
  //
  //     const sets = await itemsFacet.getWearableSets()
  //     const gotchi = await aavegotchiFacet.getAavegotchi(testAavegotchiId)
  ...
  //     const svg = await svgFacet.getAavegotchiSvg(testAavegotchiId)
  //     console.log(svg)
  //   })
  //
  ...
  //     // console.log('equipped:' + equipped)
  //
  //     // const [modifiedTraits, augmentedScore] = await aavegotchiFacet.modifiedTraitsAndRarityScore(testAavegotchiId)
  ...
  //     const [modifiedTraits, augmentedScore] = await aavegotchiGameFacet.modifiedTraitsAndRarityScore(testAavegotchiId)
  ...
  //     }
  //
  //     // const totalSupply = await aavegotchiFacet.totalSupply()
  //     const singlePortal = ethers.utils.parseEther('5500')
  //     await truffleAssert.reverts(shopFacet.buyPortals(account, singlePortal), 'ShopFacet: Exceeded max number of aavegotchis for this haunt')
  //
  //     //  const receipt = await tx.wait()
  //   })
  //
  ...
  //     currentHaunt = await aavegotchiGameFacet.currentHaunt()
  ...
  //     // 3 = pixelcraft (17%)
  //
  //     let revenueShares = await aavegotchiGameFacet.revenueShares()
  //     const beforeBalances = []
  //     for (let index = 0; index < 4; index++) {
  //       const address = revenueShares[index]
  //       const balance = await ghstTokenContract.balanceOf(address)
  //       beforeBalances[index] = balance
  //     }
  //
  //     // Buy 10 Portals
  //     await shopFacet.buyPortals(account, ethers.utils.parseEther('1500'))
  //
  ...
  //     revenueShares = await aavegotchiGameFacet.revenueShares()
  //
  ...
  //       const afterBalance = ethers.BigNumber.from(await ghstTokenContract.balanceOf(address))
  ...
  //     await shopFacet.purchaseItemsWithGhst(account, ['114', '115', '116', '126', '127', '128', '129'], ['10', '10', '10', '100', '10', '10', '10'])
  //     balances = await itemsFacet.itemBalances(account)
  ...
  //     const oldAavegotchi = await aavegotchiFacet.getAavegotchi(testAavegotchiId)
  //
  ...
  //     await aavegotchiFacet.spendSkillPoints(testAavegotchiId, [1, 0, 0, 0])
  //     const skillPoints = await aavegotchiFacet.availableSkillPoints(testAavegotchiId)
  //     expect(skillPoints).to.equal(0)
  //
  //     const newAavegotchi = await aavegotchiFacet.getAavegotchi(testAavegotchiId)
  //
  ...
  //     // const aavegotchi = await aavegotchiFacet.getAavegotchi('0')
  //     // let score = await aavegotchiFacet.baseRarityScore(sixteenBitIntArrayToUint([0, 0, 0, -1, 0, 0]))
  //     // expect(score).to.equal(601)
  //     // await daoFacet.updateCollateralModifiers(aavegotchi.collateral, [2, 0, 0, 0, 0, 0])
  //     // score = await aavegotchiFacet.baseRarityScore([0, 0, 0, 0, 0, 0], aavegotchi.collateral)
  ...
  //     ethers.provider.send('evm_mine')
  //
  //     let kinship = await aavegotchiGameFacet.kinship('0')
  ...
  //     await interactAndUpdateTime()
  //
  //     kinship = await aavegotchiGameFacet.kinship('0')
