...
describe("Airdrop SZN5 Baadges", async function () {
  ...
  it.only("Should airdrop szn5 2nd and 3rd place baadges", async function () {
    //rarity 2nd
  ...
  it.only("Should airdrop szn5 top10 baadges", async function () {
    //rarity top 10
  ...
  it.only("Should airdrop szn5 top100 baadges", async function () {
    //rarity top 100
