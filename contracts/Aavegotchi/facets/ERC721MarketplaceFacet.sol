...
contract ERC721MarketplaceFacet is Modifiers {
    ...
    function updateERC721ListingPrice(uint256 _listingId, uint256 _priceInWei) external diamondPaused {
    ...
    function batchUpdateERC721ListingPrice(uint256[] calldata _listingIds, uint256[] calldata _priceInWeis) external diamondPaused {
    ...
    function cancelERC721ListingByToken(address _erc721TokenAddress, uint256 _erc721TokenId) external diamondPaused {
    ...
    function cancelERC721Listing(uint256 _listingId) external diamondPaused {
    ...
    function updateERC721Listing(address _erc721TokenAddress, uint256 _erc721TokenId, address _owner) external diamondPaused {
