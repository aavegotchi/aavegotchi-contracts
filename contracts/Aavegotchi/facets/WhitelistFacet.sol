...
contract WhitelistFacet is Modifiers {
    ...
    function createWhitelist(string calldata _name, address[] calldata _whitelistAddresses) external diamondPaused {
    ...
    function updateWhitelist(uint32 _whitelistId, address[] calldata _whitelistAddresses) external diamondPaused {
        require(_whitelistAddresses.length > 0, "WhitelistFacet: Whitelist length should be larger than zero");
    ...
    function removeAddressesFromWhitelist(uint32 _whitelistId, address[] calldata _whitelistAddresses) external diamondPaused {
        require(_whitelistAddresses.length > 0, "WhitelistFacet: Whitelist length should be larger than zero");
        require(LibWhitelist._whitelistExists(_whitelistId), "WhitelistFacet: Whitelist not found");
        require(LibWhitelist.checkWhitelistOwner(_whitelistId), "WhitelistFacet: Not whitelist owner");
    ...
    function transferOwnershipOfWhitelist(uint32 _whitelistId, address _whitelistOwner) external diamondPaused {
        require(LibWhitelist._whitelistExists(_whitelistId), "WhitelistFacet: Whitelist not found");
        require(LibWhitelist.checkWhitelistOwner(_whitelistId), "WhitelistFacet: Not whitelist owner");
    ...
    function setWhitelistAccessRight(uint32 _whitelistId, uint256 _actionRight, uint256 _accessRight) external diamondPaused {
        require(LibWhitelist._whitelistExists(_whitelistId), "WhitelistFacet: Whitelist not found");
        require(LibWhitelist.checkWhitelistOwner(_whitelistId), "WhitelistFacet: Not whitelist owner");
    ...
    function setBorrowLimit(uint32 _whitelistId, uint256 _borrowlimit) external diamondPaused {
        require(LibWhitelist._whitelistExists(_whitelistId), "WhitelistFacet: Whitelist not found");
        require(LibWhitelist.checkWhitelistOwner(_whitelistId), "WhitelistFacet: Not whitelist owner");
