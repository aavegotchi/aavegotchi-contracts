...
contract AavegotchiFacet is Modifiers {
    ...
    function _enforceAavegotchiNotEquippedWithDelegatedItems(uint256 _tokenId) internal view {
        require(s.gotchiEquippedDepositsInfo[_tokenId].equippedDelegatedWearablesCount == 0, "AavegotchiFacet: Can't transfer when equipped with a delegated wearable");
    }
