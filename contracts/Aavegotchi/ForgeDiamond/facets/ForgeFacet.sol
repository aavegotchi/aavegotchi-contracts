...
contract ForgeFacet is Modifiers {
    ...
    function mintEssence(address owner /*uint256 gotchiId*/) external {
        require(LibMeta.msgSender() == s.aavegotchiDiamond, "ForgeFacet: Can only be called by Aavegotchi Diamond");
