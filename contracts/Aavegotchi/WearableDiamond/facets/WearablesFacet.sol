...
contract WearablesFacet {
    function periphery() internal view returns (PeripheryFacet pFacet) {
        pFacet = PeripheryFacet(WearableLibDiamond.diamondStorage().aavegotchiDiamond);
    }

    function itemsFacet() internal view returns (ItemsFacet iFacet) {
        iFacet = ItemsFacet(WearableLibDiamond.diamondStorage().aavegotchiDiamond);
    }

    function aavegotchiFacet() internal view returns (AavegotchiFacet aFacet) {
        aFacet = AavegotchiFacet(WearableLibDiamond.diamondStorage().aavegotchiDiamond);
    }
