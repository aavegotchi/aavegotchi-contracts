...
async function main() {
  if (!["mumbai", "hardhat", "localhost"].includes(hre.network.name)) {
    throw Error("No network settings for " + hre.network.name);
  }

  const ghstDiamondAddress = "0xc93A55a39356BddA580036Ce50044C106Dd211c8";
  ...
  const wearableDiamondAddress = await deployAndUpgradeWearableDiamond(
    "0x38d67a8cb93ed3795764ec2ecf8ea284da329936",
    "0x613d34492e7f105c74b7923648653a1e57e5a852",
    "0x1709d0d0e696d64bce8add21da8f61f7a641dfaa",
    aavegotchiDiamond.address
  );
