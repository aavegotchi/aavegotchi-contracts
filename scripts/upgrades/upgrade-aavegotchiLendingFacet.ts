  ...
  const facets: FacetsAndAddSelectors[] = [
    {
      ...
      addSelectors: [
        ...
        "function addAavegotchiRental(uint256 _erc721TokenId, uint256 _initialCost, uint256 _period, uint256[3] calldata _revenueSplit, address _originalOwner, address _receiver, uint256 _whitelistId, address[] calldata _includes) external",
