...
async function main () {
  ...
  const newFuncs = [
    getSelector('function batchBatchTransferToParent(address _from, address _toContract, uint256[] calldata _toTokenIds, uint256[][] calldata _ids, uint256[][] calldata _values) external')
  ]
...
if(require.main === module){
  main()
    ...
    exports.addBatchBatchTransfer = main;
