...
async function main () {
  ...
  const aavegotchi = diamond.deploy({
    diamondName: 'Aavegotchi',
    owner: account,
    facetNames: [
      'DiamondCutFacet',
      'DiamondLoupeFacet',
  ...
  // const IAavegotchiDiamond = await ethers.getContractFactory(
  //   'IAavegotchiDiamond'
  // )
  // const iAavegotchiDiamond = IAavegotchiDiamond.attach(
  ...
  //   diamondAddress: ghstDiamondAddress,
  //   facetNames: ['Upgrade1']
  // })
  // ----------------------------------------------------------------
