...
const { paacmanGotchis } = require('../../data/airdrops/paacman.tsx')
...
async function main () {
  ...
  console.log(`Sending ${xpAmount} to ${paacmanGotchis.length} addresses!`)

  // group the data
  const txData = []
  let txGroup = []
  let tokenIdsNum = 0
  for (const gotchiID of paacmanGotchis) {
