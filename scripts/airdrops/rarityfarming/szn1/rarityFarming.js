...
const { rarityFarmingKickoffAddresses, rarityFarmingKickoffGotchisOwned } = require('../../data/airdrops/rarityFarmingKickoff.tsx')
...
async function main () {
  ...
  const data = rarityFarmingKickoffGotchisOwned.data.users
  ...
  console.log(`Sending ${xpAmount} XP to ${addresses.length} addresses!`)
