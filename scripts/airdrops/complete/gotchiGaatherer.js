...
const { gotchiGaatherer10, gotchiGaatherer5 } = require('../../data/airdrops/gotchiGaatherer.tsx')
...
async function main () {
  ...
  let aavegotchis = gotchiGaatherer5

  const maxProcess = 500
  const xpAmount = 5

  console.log(`Sending ${xpAmount} to ${aavegotchis.length} aavegotchis!`)
