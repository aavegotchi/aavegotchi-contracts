...
const { aapprenticeAddresses, aapprenticeGotchisOwned } = require('../../data/airdrops/aapprentices.tsx')
...
async function main () {
  ...
  const addresses = aapprenticeAddresses
  const data = aapprenticeGotchisOwned.data.users
