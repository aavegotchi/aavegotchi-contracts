...
const { rarityRoundThree, kinshipRoundThree, xpRoundThree } = require('../../data/rarityFarmingRoundThree.tsx')
...
async function main () {
  ...
  for (let index = 0; index < 5000; index++) {
    const rarityGotchiID = rarityRoundThree[index];
    const kinshipGotchiID = kinshipRoundThree[index]
    const xpGotchiID = xpRoundThree[index]
