...
const { agip8Addresses:addresses, agip8GotchisOwned:gotchis } = require('../../../data/airdrops/coreprop/agip8.tsx')
...
async function main () {
  ...
  for (const [i, txGroup] of txData.entries()) {
    ...
    const tx = await dao.grantExperience(tokenIds, Array(tokenIds.length).fill(xpAmount), { /*gasLimit: 10000000,*/  gasPrice: 10000000000 })
